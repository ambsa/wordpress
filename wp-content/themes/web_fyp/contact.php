...
<section class="mb-20">
    <div class="container mx-auto px-6 lg:px-20 mt-10 sm:mt-20 md:mt-24 lg:mt-30">
        ...
        <div class="text-xl sm:text-xl lg:text-2xl font-normal text-slate-100 mt-5">
...
<section>
    <div class="max-w-5xl mx-auto p-6">
        <form action="/submit-form" method="POST" class="space-y-4 text-slate-100">
            ...
            <div>
                <div>
                    <button type="submit" class="w-1/2 md:w-1/5 px-4 py-2 mt-5 bg-gradient-to-r from-[#6A00F4] to-[#D700FF] lg:bg-white lg:text-black rounded-full font-semibold flex items-center justify-center transition-all duration-300 ease-in-out">
                        Kirim Pesan Ini
                        <i class="fi fi-rr-arrow-up-right text-white lg:text-black text-xs ml-3 font-semibold"></i>
                    </button>
                </div>
            </div>
        </form>
...
<!-- bg-gradient-to-r from-[#6A00F4] to-[#D700FF] text-white -->
